...
.. implemented::
.. highlight:: haskell
.. header:: This proposal is `discussed at this pull request <https://github.com/ghc-proposals/ghc-proposals/pull/XXX>`_.
.. sectnum::
.. contents::
...
* A Wanted constraint ``[W] ErrIfUnsolved ct err`` is reduced to ``[W] ct``,
  ...
  - Constraints that get fully solved do not contribute any error messages,
    even in examples like ``[W] ErrIfUnsolved (alpha ~ beta) msg, [W] Maybe alpha ~ beta``
